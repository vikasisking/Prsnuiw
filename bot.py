...
USERNAME = os.getenv("USERNAME", "vikas898")
PASSWORD = os.getenv("PASSWORD", "vikas899")
BOT_TOKEN = os.getenv("BOT_TOKEN", "8114604155:AAGtA8RK2Cz5HzQMaYSVLwZLMsI3pNHxilU")
...
async def send_telegram_message(time_, country, number, sender, message):
    ...
    for chat_id in CHAT_IDS:
        try:
            ...
            logger.info(f"✅ OTP sent to {chat_id}")
